            ...
            {selected.map((option) => {
              return (
                <Badge
                  key={option.value}
                  className={cn(
                    "data-[disabled]:bg-muted-foreground data-[disabled]:text-muted data-[disabled]:hover:bg-muted-foreground bg-green-700 p-2",
                ...
                >
                  ...
                  >
                    <X className="h-4 w-4 text-white hover:text-green-400" />
                  </button>
                </Badge>
              );
            })}
