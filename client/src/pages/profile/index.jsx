  ...
  return (
    <div className="bg-[#101332] h-[100vh] flex items-center justify-center flex-col gap-10 ">
      <div className=" w-[80vw] md:w-max flex flex-col gap-10">
          ...
          <div className="flex min-w-32 md:min-w-64 flex-col gap-5 text-white items-center justify-center">
            <div className="w-full">
              <Input
                placeholder="Email"
                type="email"
                className="rounded-lg  p-6 bg-[#191d44] border-none"
                disabled
        ...
        <div className="w-full">
        <Button
  className="h-16 w-full bg-gradient-to-r from-[#65FA7D] to-[#24A488] hover:from-[#4bcf68] hover:to-[#1f8f71] transition-all duration-300 text-white font-semibold shadow-md"
  onClick={saveChanges}
>
  Save Changes
</Button>
