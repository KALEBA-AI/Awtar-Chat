      ...
      >
          ...
          <div
            className={`${
              message.sender !== selectedChatData._id
                ? "bg-[#24A488]/5 text-[#24A488]/90 border-none rounded-full"
                : "bg-[#252C67]/50 text-white/80 border-none rounded-full"
        ...
        {message.messageType === MESSAGE_TYPES.FILE && (
          <div
            className={`${
              message.sender !== selectedChatData._id
                ? "bg-[#24A488]/5 text-[#24A488]/90 border-none"
                : "bg-[#252C67]/50 text-white/80 border-none"
