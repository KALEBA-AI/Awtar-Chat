...
const MessageBar = () => {
  ...
  return (
    <div className="h-[10vh] bg-[#101332] flex justify-center items-center px-8 gap-6 mb-5">
      <div className="flex-1 flex bg-[#252C67] rounded-full items-center gap-5 pr-5">
        <input
          type="text"
