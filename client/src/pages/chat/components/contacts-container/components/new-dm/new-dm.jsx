  ...
  return (
    <>
      ...
      <Dialog open={openNewContactModal} onOpenChange={setOpenNewContactModal}>
        <DialogContent className="bg-[radial-gradient(circle_at_left,#252C67,#101332)] border-none text-white w-[400px] h-[400px] flex flex-col">
          <DialogDescription className="hidden">
            Please select a contact
          </DialogDescription>
          <DialogHeader>
            <DialogTitle>Select a contact from Awtar</DialogTitle>
          </DialogHeader>
          <div>
            <Input
              placeholder="Search Contacts"
              className="rounded-lg p-6 bg-[#252C67] border-none"
              ...
              {searchedContacts.length <= 0 && (
                <div className="flex-1  md:flex mt-5  flex-col justify-center items-center hidden duration-1000 transition-all">
                  ...
                  <div className="text-opacity-80 text-white  flex flex-col gap-5 items-center mt-5 lg:text-2xl text-xl transition-all duration-1000 text-center">
                    <h3 className="poppins-regular">Search new
                      <span className="bg-gradient-to-r from-[#65FA7D] to-[#24A488] bg-clip-text text-transparent"> Contact. </span>
                    </h3>
                  </div>
                </div>
              )}
