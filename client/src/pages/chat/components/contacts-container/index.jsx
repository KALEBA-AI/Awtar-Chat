...
const ContactsContainer = () => {
  ...
  return (
<div className="relative md:w-[35vw] lg:w-[30vw] xl:w-[20vw] w-full border-r-2 border-none bg-[radial-gradient(circle_at_left,#252C67,#101332)] ">
<div className=" pt-3">
        <Logo />
      </div>
      <div className="my-5">
        <div className="flex items-center justify-between pr-10">
          <Title text="Peer Chat" />
          <NewDM />
        </div>
